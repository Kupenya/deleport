...
import { Mail, Instagram, Youtube, Video } from "lucide-react";
import Magnetic from "../components/Magnetic";

const Contact = () => {
  const socialLinks = [
    { icon: Mail, label: "Email", href: "mailto:hello@fetuga.com" },
    ...
    >
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-5xl md:text-8xl lg:text-[12rem] font-heading font-bold tracking-tighter uppercase leading-none mb-12">
            Let’s tell <br />
